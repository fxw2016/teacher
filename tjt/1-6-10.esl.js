...
function(e) {
    function r(e, r) {
        ...
        return j(e) && t && (z && clearTimeout(z), z = setTimeout(n, 1e3 * t)),
        C(e, r)
    }
    function n() {
        var e, r = [],
        n = [],
        t = {};
        for (var i in F) f(i) || (e = 1, r.push(i)),
        A(F[i].depMs || [],
        function(r) {
            var i = r.absId;
    ...
    function o() {
        ...
        function(r) {
            if (! (r.state > P)) {
                ...
                i = 0,
                a = r.factory;
                "function" == typeof a && (i = Math.min(a.length, t), a.toString().replace(G, "").replace(Q,
                function(e, r, t) {
                    n.push(t)
                })),
                A(n,
    ...
    function I(e) {
        function r() {
            var r = n.readyState; ("undefined" == typeof r || /^(loaded|complete)$/.test(r)) && (n.onload = n.onreadystatechange = null, n = null, y(e))
        }
        if (!nr[e] && !F[e]) {
            nr[e] = 1;
    ...
    function w(e) {
        ...
        a = e,
        o = "";
        t.test(e) && (o = RegExp.$1, e = e.replace(t, "")),
        n.test(e) && (i = RegExp.$1, a = e.replace(n, ""));
        var u, s = a;
        A(ir,
        function(e) {
            var r = e.k;
        ...
        /^([a-z]{2,10}:\/)?\//i.test(s) || (s = tr.baseUrl + s),
        s += i + o;
        var c;
        return A(sr,
        function(e) {
    ...
    function R() {
        ...
        for (var e = document.getElementsByTagName("script"), r = e.length; r--;) {
            var n = e[r];
            if ("interactive" === n.readyState) return fr = n,
            n
        }
    }
    function T(e) {
        cr = e,
        lr ? vr.insertBefore(e, lr) : vr.appendChild(e),
        cr = null
    }
    function $(e) {
        return new RegExp("^" + e + "(/|$)")
